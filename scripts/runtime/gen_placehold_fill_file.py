...
if __name__ == "__main__":
    if len(sys.argv) < 4:
        ...
        print("Example: ${MYCLASH_ROOT_PWD}/scripts/runtime/gen_placehold_fill_file.py ${MYCLASH_ROOT_PWD}/install/templates/myclash.service ${MYCLASH_ROOT_PWD}/cache/myclash.service.gen ${MYCLASH_ROOT_PWD} ${MYCLASH_ROOT_PWD} ${MYCLASH_ROOT_PWD} ${MYCLASH_ROOT_PWD}")
        sys.exit(1)
